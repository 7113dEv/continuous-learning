...
class Maze():
    ...
    def create_maze(self):
        ...
        context = self.get_maze_context_from_file()
    ...
    def solve_maze(self, search_type: str = None):
        ...
        while solving_maze:
            ...
            actions = self.generate_possible_actions_from(current_node)
        ...
        for i, row in enumerate(self.maze_walls):
            ...
            for j, col in enumerate(row):
                ...
                # Print start/goal
                    ...
                    row_string += f"{'A' * ((i, j) == self.start)}{'B' * ((i, j) == self.goal)}"
